...
sed -i "38 i HEADERS += ${root}/client/cli.h ${root}/client/client_publish.h ${root}/client/client_query.h ${root}/client/client_permdb_manager.h ${root}/client/client_key_manager.h ${root}/client/client_apnet.h ${root}/client/client_uenet.h ${root}/client/client_register.h ${root}/client/client_generic_interface.h ${root}/utils/utils.h ${root}/utils/encryption.h ${root}/utils/errors.h ${root}/benchmark/timer.h ${root}/config_macros.h ${root}/sample_libcrypto/sample_libcrypto.h" graphical-client.pro 
